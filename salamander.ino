...
void wave(Servo *segment, int counter, int n);
...
void loop() {
    ...
    for (int counter = 0; counter < 180; counter++) {
        wave(&servo1, counter, 0);
        wave(&servo2, counter, 1);
        wave(&servo3, counter, 2);
        wave(&servo4, counter, 3);
        delay(10);
    }
    delay(1000); 
    ...
    for (int counter = 180; counter < 360; counter++) {
        wave(&servo1, counter, 0);
        wave(&servo2, counter, 1);
        wave(&servo3, counter, 2);
        wave(&servo4, counter, 3);
